...
class User extends  Querybuild
{
    ...
    **/
    ...
    {
        $query = $this->querys['db_settings']['me'];
    ...
    public function get_the_name(){
        //{"details":{"name":"Administrador ","last_name":"Smart Water ","register":"2016-06-19","avatar":"3SbInzFt-avatar-smart.png","occupation":"Supervisor","location":"El Salvador","website":"www.smartwatersv.com"},"last_passwords":{}}
        return $this->get_data_other_user()->details->name  ?? null ;
    }

    
    public function get_all_name(){
        $obj        = $this->get_data_other_user(); 
        $name       = $obj->details->name ?? "";
        $last       = $obj->details->last_name ?? "";
        return $name . " " . $last;
    }


    protected function get_data_other_user(){
        return json_decode($this->other_user->data) ?? null ;
    }
