...
<div id="overview" style="display: none; width: 100%; height:200px;"></div>
<div  id="controls-pipes" class="toolsDrag" style=" width: 100%; min-height: 150px; "></div>
    ...
    <div style="" class="col-md-12">
        ...
        <div class="portlet light bordered ">
            ...
            <div class="portlet-title ">
                <div class="col-md-9">
                    <div id="controls" style="width:100%; min-height:200px;margin:0;padding:0;border:none;font-size:50px;color:#FF0000; "></div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="scada-margin m-heading-1 border-green m-bordered">
                        ...
                        <a class="btn blue btn-outline theMargin" href="" >
