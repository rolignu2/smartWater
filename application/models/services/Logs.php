...
class Logs extends CI_Model implements CoreInterface
{
    ...
    {
        return $this->load->view("service/logs" , [] , true);
    }
    ...
    public function _css()
    {
        ...
        return print_css([
            ...
            "/content/assets/global/plugins/bootstrap-editable/inputs-ext/address/address.css"
        ]);
    }
    ...
    public function _javascript()
    {
        return [
            ...
            array(
                "type"          => "text/javascript" ,
                "location"      => "footer" ,
                "script"        => site_url() . 'content/assets/global/plugins/jquery.mockjax.js',
                "systemjs"      => false
            ),
            array(
                "type"          => "text/javascript" ,
                "location"      => "footer" ,
                "script"        => site_url() . 'content/assets/global/plugins/bootstrap-editable/bootstrap-editable/js/bootstrap-editable.js',
                "systemjs"      => false
            ),
            array(
                "type"          => "text/javascript" ,
                "location"      => "footer" ,
                "script"        => site_url() . 'content/assets/global/scripts/datatable.js',
                "systemjs"      => false
            ),
            array(
                "type"          => "text/javascript" ,
                "location"      => "footer" ,
                "script"        => site_url() . 'content/assets/global/plugins/datatables/datatables.min.js',
                "systemjs"      => false
            ),
            array(
                "type"          => "text/javascript" ,
                "location"      => "footer" ,
                "script"        => site_url() . 'content/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js',
                "systemjs"      => false
            ),
            array(
                "type"          => "text/babel" ,
                "location"      => "header" ,
                "script"        => site_url() . 'content/assets/apps/services/Logs.jsx',
                "systemjs"      => false
            )
        ];
    }
