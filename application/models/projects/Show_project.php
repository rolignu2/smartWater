...
class Show_project extends CI_Model implements CoreInterface
{
    ...
    public function _render($params = NULL)
    {
        ...
        $particle_url       =  $this->meta->get_meta_value("particle_url");
        $particle_photon    =  $this->meta->get_meta_value("particle_photon_get");

        return $this->load->view("projects/show_projects" , [
            "purl"  => $particle_url,
            "pget"  => $particle_photon
        ] , TRUE );
    }
    ...
    public function _javascript()
    {
        ...
        return [
                ...
                array(
                    "type"          => "text/javascript" ,
                    "location"      => "header" ,
                    "script"        => site_url() . 'content/assets/pages/scripts/components-bootstrap-select.min.js',
                    "systemjs"      => false
                ),
                ...
                array(
                    "type"          => "text/babel" ,
                    "location"      => "header" ,
                    "script"        => site_url() . 'content/assets/apps/projects/project_show_render.jsx',
                    "systemjs"      => false
                )
        ];
    }
